...
class AuthenticationData{
  ...
  Future<Operation> validateEmail(Dio dio, EmailValidationRequest validationRequest,String baseUrl) async{

    try{
      var response = await dio.post(
        '$baseUrl/api/user/email/validate',
      ...
      if(response.statusCode == 508 || response.statusCode == 408){
        ...
        EmailValidationResponse data = EmailValidationResponse.fromJson(response.data);
        return Operation(response.statusCode, data);
